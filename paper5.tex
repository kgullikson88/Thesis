...
\begin{itemize}
\item $T_\mathrm{eff} = 3000-7000$ K\footnote{We extend the grid to higher temperatures if the measured temperature (see Section \ref{subsec:systematics}) is near 7000 K}, in steps of 100 K
...
\begin{longtable}{lllcccrcc}
    ...
    \caption{Early type star sample.\\
             The spectral types are adopted from the Simbad database \citep{Simbad}. \label{tab:earlycal}} 
    \\ \hline
     & & & & & & & & Exp. Time \\
...
\begin{longtable}{lcccccrccc}
    ...
    \caption{Known Binary Stars.\\
             The spectral types are from the Simbad database \citep{Simbad}. \label{tab:known}} 
     \\ \hline
     & & & & & & & & Exp. Time \\
     Star & RA & DEC & V & K & (K) & Instrument  & Date  & (min) \\ \hline
    \endfirsthead
...
\begin{longtable}{cccccccc}
    ...
    \caption{Companion Data.\\ \label{tab:measured}}
    \\ \hline
